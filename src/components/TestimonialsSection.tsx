...
const testimonials = [
  {
    quote:
      "Быстро и результативно! Заказывал лендинг для запуска продукта, и roboweb.team меня не разочаровали. Заявки пошли с первого дня. :)",
    name: "Патрик",
    role: "Предприниматель",
  },
  {
    quote:
      "Нам нужно было корпоративное мобильное приложение для сотрудников. roboweb.team создали для нас отличный продукт, полностью под наши нужды, который избавил команду от рутины.",
    name: "Мехмет",
